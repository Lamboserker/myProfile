              ...
              <section className="mb-4">
                <div className="d-flex justify-content-center mb-4">
                  ...
                  {[
                    {
                      icon: faFacebookF,
                      url: "https://www.facebook.com/lukas.lamberz/",
                      name: "Facebook",
                    },
                    {
                      icon: faTwitter,
                      url: "https://twitter.com/LamberzLukas",
                      name: "Twitter",
                    },
                    {
                      icon: faInstagram,
                      url: "https://www.instagram.com/lukas.lamberz/",
                      name: "Instagram",
                    },
                    {
                      icon: faLinkedinIn,
                      url: "https://www.linkedin.com/in/lukas-lamberz/",
                      name: "LinkedIn",
                    },
                    {
                      icon: faGithub,
                      url: "https://github.com/lamberzl",
                      name: "GitHub",
                    },
                  ].map(({ icon, url, name }) => (
                    <div
                    ...
                    >
                      ...
                      >
                        <FontAwesomeIcon
                          ...
                          size="2x"
                          className={`icon ${
                            hoveredIcon === name ? "hide" : ""
                          }`}
                        />
                        <span
                          className={`icon-text ${
                            hoveredIcon === name ? "show" : ""
                          }`}
                        >
                          {name}
                        </span>
