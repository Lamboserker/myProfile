          ...
          <div className="text-center p-3">
            ...
            <section className="mb-4">
              ...
              <div className="d-flex justify-content-center mb-4">
                ...
                >
                  <a
                    href="www.linkedin.com/in/lukas-oliver-lamberz-206b30262"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="no-underline"
                  >
